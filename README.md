...
![equation](https://latex.codecogs.com/svg.image?(\mathbf{\Sigma}_{L1},\mathbf{V}_{L1})=\underset{\mathbf{V}\in\mathbb{S}^{N\times{K}},\mathbf{\Sigma}\in{\rm{diag}}(\mathbb{R}^K)}{\rm{argmin}}||\mathbf{U}_{L1}^T\mathbf{X}-\mathbf{\Sigma}\mathbf{V}^T||_{1,1}&space;)
---
