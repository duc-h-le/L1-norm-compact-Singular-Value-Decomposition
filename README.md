...
![equation](https://latex.codecogs.com/svg.image?(\mathbf{\Sigma}_{L1},\mathbf{V}_{L1}^T)=\underset{ \substack{{\mathbf{V}} \in \mathbb{S}^{N\times K,},\mathbf{\Sigma} \in {\rm diag}(\mathbb{R}^{K})}}{\rm argmin}&space;)
---
